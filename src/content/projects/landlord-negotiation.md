...
Built interactive simulator at QHacks helping first-time renters practice lease negotiations with real-time AI landlord responses. Designed user flows in Figma and integrated Flask backend with third-party API to orchestrate conversations.
